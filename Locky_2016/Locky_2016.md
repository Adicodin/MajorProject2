...
Locky (2016,17c3d74e3c0645edb4b5145335b342d2929c92dff856cca1a5e79fa5d935fec2 (SHA-256)) is distributed through spam emails carrying macro-enabled Office attachments (subjects like "ATTN: Invoice J-98223146"). On macro execution, an obfuscated VBS routine issues a GET request to a compromised remote server (e.g., www[.]jesusdenazaret[.]com[.]ve/34gf5y/r34f3345g.exe) to download the Locky payload as ladybi.exe into %TEMP%. Once executed, the binary copies itself as svchost.exe, deletes the original, and runs from the new location. It establishes persistence via a Run key and deletes Volume Shadow Copies using vssadmin. C2 communication occurs over HTTP POST to domains generated by a DGA, used to fetch the per-victim RSA public key — encryption only begins after this key is retrieved. Files are encrypted and renamed with the .locky extension, and a recovery-instructions ransom note is dropped. 
